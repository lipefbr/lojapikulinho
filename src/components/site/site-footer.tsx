    ...
    <footer className="mt-auto bg-plum text-cream">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-5 text-xs text-cream/60 md:flex-row">
          <p>© {new Date().getFullYear()} Pijulinho. Feito com 💛 para a criançada por <a href="https://lipe.host" target="_blank" rel="noopener noreferrer" className="inline-block text-tangerine font-semibold hover:underline transition-colors">Lipe.Host</a></p>
